  ...
  <div class="app-container">
    <el-card class="admin-card" shadow="hover">
      ...
      <el-table :data="dataList" stripe style="width: 100%" :header-cell-style="{ color: '#2c3e50', backgroundColor: '#f2f2f2' }" v-loading="loading">
        ...
        <el-table-column prop="title" label="标题" show-overflow-tooltip min-width="250"> </el-table-column>
    ...
    <FormDialog destroyOnClose :title="'公告' + dialogTitle" ref="formDialogRef" @dialogClosed="dialogClosed" @submit="handleSubmit">
