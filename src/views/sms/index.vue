    ...
    <el-card class="sms-card" shadow="hover">
      <ListHeader :rule="{ delete: 76 }" @delete="handleMultiDelete">
        <el-form class="search-form" :model="params" ref="searchRef" label-width="0px" size="small">
          ...
          <el-form-item label="">
            <el-input v-model="params.receive_phone" placeholder="接收人电话" clearable @clear="getData(1)"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-date-picker
              style="width: 45%"
      ...
      >
        ...
        <el-table-column prop="status" label="状态" width="120">
          <template #default="scope">
            <el-tag size="small" :type="scope.row.status == 1 ? 'success' : 'info'">{{ scope.row.status == 1 ? '成功' : '失败' }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="fail_reason" show-overflow-tooltip width="120" label="失败原因"> </el-table-column>
        <el-table-column prop="receive_phone" label="接收人电话" width="150"> </el-table-column>
