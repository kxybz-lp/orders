  ...
  if (localStorage.getItem('order_columns_' + store.state.adminInfo.id)) {
    ...
    if (store.state.adminInfo.branch_id == 1) {
      columns.value = [
        ...
        { id: 16, prop: 'other', label: '备注', isDrag: 'drag', sortable: false, minWidth: 140, show: true },
        ...
        { id: 24, prop: 'order_money', label: '交定金额', sortable: false, minWidth: 120, isDrag: 'drag', show: true },
        ...
        { id: 26, prop: 'contract_money', label: '签单产值', sortable: false, minWidth: 120, isDrag: 'drag', show: false },
      ...
      columns.value = [
        ...
        { id: 42, prop: 'other', label: '备注', sortable: false, minWidth: 140, isDrag: 'drag', show: true },
        { id: 17, prop: 'arrange_time', label: '派单时间', sortable: true, minWidth: 150, isDrag: 'drag', show: true },
        { id: 18, prop: 'branch_name', label: '接单公司', sortable: false, minWidth: 140, isDrag: 'drag', show: true },
        { id: 20, prop: 'status_name', label: '订单状态', sortable: false, minWidth: 120, isDrag: 'drag', show: true },
        { id: 22, prop: 'deal_time', label: '反馈交定时间', sortable: true, minWidth: 150, isDrag: 'drag', show: true },
