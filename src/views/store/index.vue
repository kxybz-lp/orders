<template>
  <div class="app-container">
    <el-card class="admin-card" shadow="hover">
      <el-form class="search-more" :model="params" ref="searchMoreRef" label-width="80px" size="small" v-if="showSearch">
        <el-row :gutter="2">
          ...
          <el-col :md="6" :offset="0">
            <el-form-item label="状态">
              <el-input v-model="params.docking_phone" placeholder="状态" clearable @clear="getData"></el-input>
            </el-form-item>
          </el-col>
          <el-col :md="6" :offset="0">
      ...
      <ListHeader ref="headerRef" :rule="{ create: 62, export: 64, import: 65, download: 65 }" @add="handleAdd" @export="exportExcel" @import="importExcel" @download="download">
        <el-form class="search-form" :model="params" ref="searchRef" label-width="0px" size="small">
          ...
          <el-form-item>
            <el-button v-show="!showSearch" type="primary" @click="getData(1)">搜索</el-button>
      ...
      >
        ...
        <el-table-column prop="region_name" show-overflow-tooltip label="区域" width="100" />
        ...
        <el-table-column prop="status" sortable label="状态">
          <template #default="scope">
            ...
            <el-tag size="small" type="info" v-if="scope.row.status == 2">关闭</el-tag>
        ...
        <el-form-item label="公司地址" prop="address">
          <el-row :gutter="2" style="width: 100%">
            <el-col :span="12" :offset="0">
              <el-cascader v-model="area" :options="areaList" :props="{ value: 'id', label: 'areaname', children: 'children', checkStrictly: true }" placeholder="请选择省/市/区" />
            </el-col>
            <el-col :span="12" :offset="0">
