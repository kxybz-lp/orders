        ...
        <el-descriptions :column="1">
          ...
          <el-descriptions-item label="筛选条件">
            <el-descriptions :column="1" style="padding-left: 80px">
              <el-descriptions-item label="下单时间：" v-if="detail.export_filter.order_time"
                >{{ detail.export_filter.order_time[0] }} - {{ detail.export_filter.order_time[1] }}
              </el-descriptions-item>
              <el-descriptions-item label="下单时间：" v-if="detail.export_filter.order_time_start"
                >{{ detail.export_filter.order_time_start }} - {{ detail.export_filter.order_time_end }}
              </el-descriptions-item>
              <el-descriptions-item label="派单时间：" v-if="detail.export_filter.arrange_time"
                >{{ detail.export_filter.arrange_time[0] }} - {{ detail.export_filter.arrange_time[1] }}
              </el-descriptions-item>
              <el-descriptions-item label="下单时间：" v-if="detail.export_filter.arrange_time_start"
                >{{ detail.export_filter.arrange_time_start }} - {{ detail.export_filter.arrange_time_end }}
              </el-descriptions-item>
              <el-descriptions-item label="签单时间：" v-if="detail.export_filter.deal_time">{{ detail.export_filter.deal_time[0] }} - {{ detail.export_filter.deal_time[1] }} </el-descriptions-item>
              <el-descriptions-item label="下单时间：" v-if="detail.export_filter.deal_time_start"
                >{{ detail.export_filter.deal_time_start }} - {{ detail.export_filter.deal_time_end }}
              </el-descriptions-item>
            </el-descriptions>
          </el-descriptions-item>
