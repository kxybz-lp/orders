  ...
  <div class="app-container">
    <el-card class="log-card" shadow="hover">
        ...
        <el-form class="search-form" :model="params" ref="searchRef" label-width="0px" size="default" v-if="!$store.state.isMobile">
          <el-form-item label="">
            <el-select v-model="params.type" placeholder="操作类型" clearable @clear="getData(1)">
              <el-option :value="item.id" :label="item.name" v-for="item in type" :key="item.id"> </el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="">
            <el-input v-model="params.name" placeholder="操作人" clearable @clear="getData(1)"> </el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input v-model="params.details" placeholder="操作内容" clearable @clear="getData(1)"> </el-input>
          </el-form-item>
          <el-form-item label="">
            <el-date-picker
              style="width: 45%"
      ...
      >
        ...
        <el-table-column prop="url" label="操作地址" min-width="180" show-overflow-tooltip> </el-table-column>
        <el-table-column prop="details" label="操作内容" min-width="140" show-overflow-tooltip> </el-table-column>
        <el-table-column prop="admin_name" label="操作者" min-width="120" show-overflow-tooltip> </el-table-column>
