  ...
  <div class="app-container">
    <el-card class="admin-card" shadow="hover">
      ...
      <el-table :data="dataList" stripe style="width: 100%"
        ...
        <el-table-column label="状态" min-width="150" v-permission="117">
          <template #default="scope">
        ...
        <el-table-column label="操作" width="200">
          <template #default="scope">
            <el-button v-permission="116" size="small" type="primary"
              @click="handleEdit(scope.row)">编辑 </el-button>
            <el-button v-permission="119" size="small" type="danger"
              @click="handleDelete(scope.row.id)"> 删除 </el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
    <FormDrawer :title="'户型' + drawerTitle" ref="formDrawerRef" @drawerClosed="drawerClosed"
      @submit="handleSubmit">
